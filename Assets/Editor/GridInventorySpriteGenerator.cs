    ...
    public static void GenerateGridInventorySprites()
    {
        ...
        var jobs = new[]
        {
            ...
            new WeaponGridJob(
                ...
                "Assets/Synty/PolygonMilitary/Prefabs/Weapons/SM_Wep_Pistol_01.prefab",
        ...
        var itemJobs = new[]
        {
            ...
            new ItemSpriteJob(
                ...
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Ammo/Ammo_762x39mm.asset",
                "Ammo_762x39mm",
                new Vector3(18f, 225f, 0f),
                new Vector3(0f, -0.01f, 0f),
                1.08f,
            ...
            new ItemSpriteJob(
                ...
                1.06f),
            new ItemSpriteJob(
                "Assets/Data/Items/Medical/Medical_Bandage.asset",
                "Medical_Bandage",
                new Vector3(84f, 180f, 0f),
                new Vector3(0f, -0.005f, 0f),
                1.02f,
            ...
            new ItemSpriteJob(
                ...
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_MilitaryLaptop.asset",
                "Loot_MilitaryLaptop",
                ...
                1.82f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_GasCan.asset",
                "Loot_GasCan",
                new Vector3(15f, 205f, 0f),
                Vector3.zero,
                1.08f,
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_ThermalScope.asset",
                "Loot_ThermalScope",
                new Vector3(0f, 270f, 0f),
                Vector3.zero,
                1.75f,
                1.82f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_MortarShell.asset",
                "Loot_MortarShell",
                new Vector3(18f, 225f, 90f),
                Vector3.zero,
                1.95f,
                2.05f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_LithiumBattery.asset",
                "Loot_LithiumBattery",
                new Vector3(20f, 225f, 0f),
                Vector3.zero,
                1.72f,
                1.82f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_Documents.asset",
                "Loot_Documents",
                ...
                1.86f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_Sunglasses.asset",
                "Loot_Sunglasses",
                new Vector3(12f, 205f, 0f),
                Vector3.zero,
                1.72f,
                1.88f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_Tape.asset",
                "Loot_Tape",
                new Vector3(35f, 215f, 0f),
                Vector3.zero,
                1.08f,
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_WetWipes.asset",
                "Loot_WetWipes",
                new Vector3(65f, 180f, 0f),
                Vector3.zero,
                1.04f,
                1.04f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_Toothpaste.asset",
                "Loot_Toothpaste",
                ...
                5.05f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_ToothpasteSpoon.asset",
                "Loot_ToothpasteSpoon",
                new Vector3(90f, 180f, 90f),
                Vector3.zero,
                4.9f,
                5.05f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_GoldenTeapot.asset",
                "Loot_GoldenTeapot",
                new Vector3(15f, 220f, 0f),
                Vector3.zero,
                1.08f,
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Loot_NightVisionGoggles.asset",
                "Loot_NightVisionGoggles",
                new Vector3(20f, 225f, 0f),
                Vector3.zero,
                1.08f,
                1.08f),
            new ItemSpriteJob(
                "Assets/Data/Items/Loot/Currency_USDollars.asset",
                "Currency_USDollars",
                new Vector3(35f, 220f, 0f),
                Vector3.zero,
                1.08f,
                1.08f),
        };
