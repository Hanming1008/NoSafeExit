...
void OnCollisionEnter(Collision col)
        {
            ...
            if (!appliedDamage)
            {
                appliedDamage = TryApplyIDamageableFallback(col, RealDamage);
            }
...
private bool TryApplyIDamageableFallback(Collision col, float damage)
        {
            ...
            if (Owner != null && damageableComponent != null && damageableComponent.gameObject == Owner)
                return false;
